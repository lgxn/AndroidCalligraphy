...
public class ColorExpandableListAdapter extends BaseExpandableListAdapter
{
	...
	private BindView mBindView = null;
     ...
     */
    public ColorExpandableListAdapter(Context context,
	...
	{
		boolean bindView(int nIndex, View view, Object data);
	}
    ...
    private void bindView(View view, Map<String, ?> data, String[] from, int[] to)
	{
        ...
        for (int i = 0; i < len; i++)
		{
            ...
            if (v != null)
			{
				if (mBindView == null || !mBindView.bindView(i, v, data.get(from[i])))
